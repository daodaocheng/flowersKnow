...
<%
	...
	sql = "SELECT id,ftitle FROM waterflower limit " + temp + ","
			+ pagesize;
	rs = dbt.executeQuery(sql);
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<a href="floweredit.jsp?id=<%=rs.getString("id")%>&ftype=waterflower"
														class="am-btn am-btn-default am-btn-xs am-text-secondary">
														<span class="am-icon-pencil-square-o"></span> 编辑
													</a> <a href="doflowerdelete.jsp?id=<%=rs.getString("id")%>&ftype=waterflower"
