...
<%
	...
	sql = "SELECT count(*) as total FROM familyflower";//读取总数
	...
	sql = "SELECT id,ftitle FROM familyflower limit " + temp + ","
			+ pagesize;
	rs = dbt.executeQuery(sql);
			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">管理教程</strong> / <small>manage
							flower</small>
					</div>
				</div>
					...
					<div class="am-u-sm-12 am-u-md-6">
						<div class="am-btn-toolbar">
							<div class="am-btn-group am-btn-group-xs">
								<a href="floweradd.jsp" type="button"
						...
						<form class="am-form">
							<table
								...
								<tbody>
									...
									<tr>
										<td><%=i%></td>
										<td><%=rs.getString("ftitle")%></td>
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<a href="floweredit.jsp?id=<%=rs.getString("id")%>&ftype=familyflower"
														class="am-btn am-btn-default am-btn-xs am-text-secondary">
														<span class="am-icon-pencil-square-o"></span> 编辑
													</a> <a href="doflowerdelete.jsp?id=<%=rs.getString("id")%>&ftype=familyflower"
								...
								<div class="am-fr">
									<ul class="am-pagination">
										...
										<li class="am-active"><a
											href="userlist.jsp?pagenumber=<%=j%>"><%=j%></a></li>
										<%
											} else {
													//其他页面
										%>
										<li><a href="userlist.jsp?pagenumber=<%=j%>"><%=j%></a></li>
										<%
											}
										%>
